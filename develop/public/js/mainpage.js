...
function onTabClick(event) {
  ...
  const clickTabs = document.querySelectorAll('.tab');
  clickTabs.forEach((tab) => tab.classList.remove('active'));
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const clickTabs = document.querySelectorAll('.tab');
  clickTabs.forEach((tab) => tab.addEventListener('click', onTabClick));
